      ...
      <div class="inputFrameIcon">
        ...
        <Modal v-model="modalShow" width="740" :closable="false" class-name="center_modal" type="text/css">
          <div style="text-align:center">
            ...
            <collectGroup v-if="storeShow" @close="clear"></collectGroup>
...
import umEditor from "@/components/Ueditor"
import collectGroup from "./stores/collectGroup"
...
export default {
  ...
  components: { Material, Board, collectGroup, umEditor, Emotions, Knowledge },
  methods: {
    showModal(type) {
      this.modalShow = true
      this.setFalse()
