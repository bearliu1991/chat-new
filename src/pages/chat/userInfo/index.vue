            ...
            <ScrollBar ref="scrollBar" :isAuto="false">
              <div id="basicInfo">
                <ul class="info_detail">
                  <li>
                    <span>姓名</span>
                    <FieldEditor type="name" propInfo="张三李四"></FieldEditor>
                  </li>
                  <li>
                    <span>联系电话</span>
                    <FieldEditor type="mobile" propInfo="13500000571"></FieldEditor>
                  </li>
                  <li>
                    <span>所在地区</span>
                    <div>浙江杭州</div>
                  ...
                  <li>
                    <span>微信号</span>
                    <FieldEditor type="wxMobile" propInfo="skhfkbn"></FieldEditor>
                  </li>
                  <li>
                    <span>QQ</span>
                    <FieldEditor type="qq" propInfo="96587453"></FieldEditor>
                  </li>
                  <li>
                    <span>年龄</span>
                    <FieldEditor type="age" propInfo="26"></FieldEditor>
                  </li>
                  <li>
                    <span>所属客服</span>
                    <div>
                  ...
                  <li class="tips">
                    <span>备注</span>
                    <FieldEditor type="tips" propInfo="优质潜力客户资金充足优
                    质潜力客户优质潜力客户"></FieldEditor>
                  </li>
                </ul>
                <ul class="user_tags">
